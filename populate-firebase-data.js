...
class FirebaseDataPopulator {
    ...
    async populateStyles() {
        ...
        const styles = [
            // Straight Styles
            { stylename: 'Straight', category: 'Straight', description: 'Classic straight hair', texture: 'Smooth and sleek' },
            { stylename: 'Silky Straight', category: 'Straight', description: 'Ultra-smooth silky straight', texture: 'Very fine and smooth' },
            { stylename: 'Yaki Straight', category: 'Straight', description: 'Textured straight mimicking relaxed hair', texture: 'Slightly textured' },
            
            // Wavy Styles
            { stylename: 'Body Wave', category: 'Wavy', description: 'Loose, natural-looking waves', texture: 'Soft waves' },
            { stylename: 'Loose Wave', category: 'Wavy', description: 'Gentle, flowing waves', texture: 'Relaxed wave pattern' },
            { stylename: 'Beach Wave', category: 'Wavy', description: 'Casual, tousled beach waves', texture: 'Natural wave texture' },
            { stylename: 'Water Wave', category: 'Wavy', description: 'Defined water-like wave pattern', texture: 'Consistent wave pattern' },
            { stylename: 'Ocean Wave', category: 'Wavy', description: 'Deep, flowing ocean-inspired waves', texture: 'Deep wave pattern' },
            
            // Curly Styles
            { stylename: 'Deep Wave', category: 'Curly', description: 'Deep, defined wave pattern', texture: 'Pronounced waves' },
            { stylename: 'Curly', category: 'Curly', description: 'Natural curly texture', texture: 'Spiral curls' },
            { stylename: 'Deep Curly', category: 'Curly', description: 'Tight, defined curls', texture: 'Tight curl pattern' },
            { stylename: 'Jerry Curl', category: 'Curly', description: 'Retro-style tight curls', texture: 'Processed curls' },
            { stylename: 'Spiral Curl', category: 'Curly', description: 'Defined spiral curl pattern', texture: 'Uniform spirals' },
            
            // Kinky/Coily Styles
            { stylename: 'Kinky Straight', category: 'Kinky', description: 'Straightened kinky texture', texture: 'Coarse straight' },
            { stylename: 'Kinky Curly', category: 'Kinky', description: 'Natural kinky curly texture', texture: 'Tight coils' },
            { stylename: 'Afro Kinky', category: 'Kinky', description: 'Natural afro texture', texture: 'Very tight coils' }
        ];
    ...
    async verifyData() {
        ...
        if (stylesSnapshot.size > 0) {
            ...
            console.log(`   Sample style: ${firstStyle.stylename} (${firstStyle.category})`);
        }
